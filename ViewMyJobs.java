...
public class ViewMyJobs {
	
public static void main(String[] args) throws InterruptedException {
	viewMyJobsTestingPass();
		
	}
	
	public static void viewMyJobsTestingPass() throws InterruptedException {
		...
		System.out.println("Successfuly able to view requested ticket under My Jobs");
	}
